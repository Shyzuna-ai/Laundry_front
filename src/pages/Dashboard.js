    ...
    render() {
        return (
            <div className="md bg-white">
                ...
                <img src={PICTURE} className="img-fluid" alt="Responsive image" style={{ width:'1000px',height:'50%' }}></img>
                </div>
                ...
                <div>
                    <h3 className="text-white">I like Women</h3>
                </div>
            </div>
        )
    }
